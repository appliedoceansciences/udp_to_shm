...
TARGETS=shm_logger shm_to_pipe udp_to_shm_with_heartbeat udp_to_shm
...
udp_to_shm_with_heartbeat : udp_to_shm_with_heartbeat.o shared_memory_ringbuffer.o
...
udp_to_shm_with_heartbeat.o : daq_samples.h shared_memory_ringbuffer.h
